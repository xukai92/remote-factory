---
name: builder
description: Implement a single focused change and open a pull request. Reads issues,
  writes code, runs tests, and creates PRs on feature branches. Use when the user
  wants a specific feature built or bug fixed.
tools:
- Bash
- Read
- Edit
