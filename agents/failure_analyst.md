...
description: Analyze research experiment failures by stage and root cause. Reads run
  artifacts, classifies failures, and produces structured analysis for the Strategist.
  Use after a research experiment fails.
tools:
- Bash
- Read
- Grep
...
<!-- GENERATED FILE — do not edit directly.
     Source: factory/agents/prompts/failure_analyst.md
