---
name: researcher
description: Deep research and discovery for software projects. Analyzes codebases,
  researches best practices, and synthesizes findings to inform strategy. Use when
  the user wants to study a project or research a domain before making changes.
tools:
- Bash
- Read
- WebSearch
...
<!-- GENERATED FILE — do not edit directly.
     Source: factory/agents/prompts/researcher.md
